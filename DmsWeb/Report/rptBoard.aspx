<%@ Page Title="รายงานงานค้างเกินกำหนดเสนอผู้บริหาร (สบท.1-4)" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="rptBoard.aspx.vb" Inherits="Report_rptBoard" %>
    ...
    <table style="width: 100%">
        ...
        <td></td>
            <td align="left" class="CssHead" colspan="2">
                รายงานงานค้างเกินกำหนดเสนอผู้บริหาร (สบท.1-4)</td>
        </tr>
        <tr>
