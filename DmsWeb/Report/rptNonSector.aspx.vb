...
Partial Class Report_rptNonSector
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ''Response.Redirect("../rptGrid/rptnonsector.aspx")
        ...
        Config.SaveTransLog("เรียกดูรายงานงานค้าง (Non Sector) เงื่อนไข :" & wh)
        Config.PreviewReports("../rptGrid/rptnonsector.aspx?" & wh & "&rnd=" & DateTime.Now.Millisecond, Me)
    End Sub
