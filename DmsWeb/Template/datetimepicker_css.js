...
function RenderCssCal(bNewCal) {
  ...
  //******************End Month and Year selector in arrow******************************
    ...
    funcCalback+=" var CalId = document.getElementById(id); if (datum== 'undefined') { var d = new Date(); datum = d.getDate() + '/' +(d.getMonth()+1) + '/' + (d.getFullYear()); } window.calDatum=datum;CalId.value=datum;calage();\n";
...
function NewCssCalandAge(pCtrl,pFormat,pAge,pScroller,pShowTime,pTimeMode,pHideSeconds) {
	// get current date and time
...
function calage(){
			...
			var str=document.getElementById(pCtrl).value;
			str = str.substring(6,10);
			
			var nu = new Date();
			var y1 =  parseInt(nu.getFullYear());
			var y2 = parseInt(str);
			alert(y1-y2);
			document.getElementById(pAge).value=y1-y2;
