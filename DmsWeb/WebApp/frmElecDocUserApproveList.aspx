<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master"
    AutoEventWireup="false" CodeFile="frmElecDocUserApproveList.aspx.vb" Inherits="WebApp_frmElecDocUserApproveList" %>
            ...
            <td align="left" class="Csslbl" width="15%" colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="url_field" DataTextField="doc_title" 
                            HeaderText="ชื่อเรื่อง" Target="_parent">
