<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false"    CodeFile="frmMasterPoscript.aspx.vb" Inherits="WebApp_frmMasterPoscript" %>
...
<style type="text/css">
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td class="style6">
                <asp:Button ID="btnSave0" runat="server" Text="บันทึก" CssClass="CssBtn" Visible="false" Width="60px" />
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="poscript_code" HeaderText="รหัส">
                            <ItemStyle Width="60px" HorizontalAlign="Center"></ItemStyle>
                            <HeaderStyle Width="60px" HorizontalAlign="Center"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="poscript_name" HeaderText="ชื่อ" 
                            SortExpression="poscript_name" >
