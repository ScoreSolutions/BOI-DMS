<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSearchBookByCondition.aspx.vb" Inherits="WebApp_frmSearchBookByCondition" %>
                        ...
                        <td align="left" class="Csslbl" colspan="4">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle" Width="100%" >
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="company_name" HeaderText="หน่วยงาน/องค์กร/บริษัท"  />
