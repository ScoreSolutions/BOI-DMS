<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false"    CodeFile="frmMasterObjective.aspx.vb" Inherits="WebApp_frmMasterObjective" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%">
        <tr>
            <td class="CssHead" align="left" >วัตถุประสงค์</td>
        ...
        <tr>
            ...
            <td align="left" width="80%" class="Csslbl" >
                <uc1:txtBox ID="txtCode" runat="server" IsNotNull="true" MaxLength="3" Width ="50"  />
            </td>
        </tr>
        <tr>
            <td align="right" class="Csslbl" >
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Objective_code" HeaderText="รหัส">
                            <ItemStyle Width="60px" HorizontalAlign="Center"></ItemStyle>
                            <HeaderStyle Width="60px" HorizontalAlign="Center"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="Objective_name" HeaderText="ชื่อ" 
                            SortExpression="Objective_name" >
