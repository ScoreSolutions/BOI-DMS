<%@ Page Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false"
    CodeFile="frmSearchBookSendBack.aspx.vb" Inherits="WebApp_frmSearchBookSendBack" Title="ค้นหาหนังสือเพื่อตีกลับ" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False" >
                            ...
                            <ItemTemplate>
                                <asp:Button ID="btnSendBack" runat="server" CssClass="CssBtn" Text="ตีกลับ" CommandArgument='<%# Bind("document_int_receiver_id") %>' CommandName="SendBack" Width="50px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
    ...
    <asp:Panel ID="Panel1" runat="server" Width="500">
        <table id="Table1" width="500" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
            ...
            <tr>
                ...
                <td colspan="3">
                    <uc1:txtAutoComplete ID="txtBackReason" Width="250" runat="server" Text="ไม่มีเอกสาร" IsNotNull="true" />
