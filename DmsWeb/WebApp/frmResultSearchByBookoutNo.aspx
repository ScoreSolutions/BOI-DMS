<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmResultSearchByBookoutNo.aspx.vb" Inherits="WebApp_frmResultSearchByBookoutNo" %>
                        ...
                        <td align="left" class="Csslbl" colspan="4">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle" Width="100%" >
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="bookout_no" HeaderText="เลขที่หนังสือออก" ItemStyle-Width="120px"  />
                                    <asp:TemplateField ShowHeader="True" HeaderText="เลขที่หนังสือรับ" >
                                    ...
                                    <asp:BoundField DataField="title_name" HeaderText="เรื่องที่ลงรับ"  />
                                    <asp:BoundField DataField="company_name_receive" HeaderText="ชื่อบริษัท"  />
                                    <asp:BoundField DataField="send_date" DataFormatString="{0:d MMM yy}" HeaderText="วันที่หนังสือออก" HtmlEncode="False" ItemStyle-Width="80px"  />
                                    <asp:BoundField DataField="officer_fullname" HeaderText="ผู้ลงนาม"  />
