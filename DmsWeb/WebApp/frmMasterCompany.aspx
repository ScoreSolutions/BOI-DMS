<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false"    CodeFile="frmMasterCompany.aspx.vb" Inherits="WebApp_frmMasterCompany" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%">
        <tr>
            <td class="CssHead"><span lang="TH">ข้อมูลองค์กร/บุคคล</span></td>
        ...
        <tr>
            ...
            <td width="80%" class="Csslbl" align="left" >
                <uc1:txtBox ID="txtCode" runat="server" IsNotNull="true" MaxLength="50" 
                    Width ="100" />
            </td>
        </tr>
        <tr>
            <td align="right" class="Csslbl" >ชื่อองค์กร (ไทย) :</td>
            <td align="left" class="Csslbl" >
                <uc1:txtBox ID="txtNameT" runat="server" IsNotNull="true" Width ="400" />
            </td>
        </tr>
        <tr>
            <td align="right" class="Csslbl" >ชื่อองค์กร (English) :</td>
            <td align="left" class="Csslbl" >
                <uc1:txtBox ID="txtNameE" runat="server" IsNotNull="False" Width ="400" />
            </td>
        </tr>
        <tr>
            <td align="right" class="Csslbl" >รายละเอียด :</td>
            <td align="left" class="Csslbl" >
                <uc1:txtBox ID="txtDesc" runat="server" IsNotNull="False" Width ="400" />
            </td>
        </tr>
        <tr>
            <td align="right" class="Csslbl" >ที่อยู่ :</td>
            <td align="left" class="Csslbl" >
                <uc1:txtBox ID="txtAddress" runat="server" IsNotNull="False" Width ="400" />
            </td>
        </tr>
        <tr>
            <td align="right" class="Csslbl" align="right" >
                ประเภทองค์กร :</td>
            <td align="left" align="left" >
                <uc2:cmbAutoComplete ID="cmbcomtype" runat="server" Width="400"  />
            </td>
        </tr>
        <tr>
            <td align="right" class="Csslbl" align="right" >
                อ้างอิงชื่อหน่วยงานภายใน :</td>
            <td align="left" align="left" >
                <uc2:cmbAutoComplete ID="cmbOrgID" runat="server" Width="400"  />
            </td>
        </tr>
        <tr>
            <td class="Csslbl" >รหัสหน่วยงานตาม TH-eGIF :</td>
            <td class="Csslbl" align="left" >
                <uc1:txtBox ID="txtTHeGIFCode" runat="server" IsNotNull="false" Width ="200" />
            </td>
        </tr>
        <tr>
            <td align="right" class="Csslbl">
            ...
            <td  align="left" class="Csslbl">
                <asp:CheckBox ID="chkActive" runat="server" CssClass="Csslbl" Text="ใช้งาน" Checked="true" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="2"  align="left" class="Csslbl">
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="comID" HeaderText="รหัส">
                            <ItemStyle Width="60px" HorizontalAlign="Center"></ItemStyle>
                            <HeaderStyle Width="60px" HorizontalAlign="Center"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="thaiName" HeaderText="ชื่อ (ไทย)"  >
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="engName" HeaderText="ชื่อ (Eng)" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="company_type_name" HeaderText="ประเภทองค์กร">
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="company_type_id" >
