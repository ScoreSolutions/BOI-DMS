...
Partial Class WebApp_frmSearchBookSendBack
    ...
    Private Function SearchData() As DataTable
        ...
        'whText += " and dr.organization_id_process = '" & uPara.ORG_DATA.ID & "' "
        ...
        dt = eng.SearchDocumentSendBack(whText)
        eng = Nothing
        uPara = Nothing
    ...
    Protected Sub btnYes_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnYes.Click
        ...
        If eng.SaveSendBack(uPara, Convert.ToInt64(txtIntID.Text), txtBackReason.Text.Trim) = True Then
            Config.SaveTransLog("ตีเรื่องกลับไปยังต้นทาง เลขที่หนังสือ " & eng.GetBookNoByDocumentIntReceiverID(Convert.ToInt64(txtIntID.Text)) & " สาเหตุ " & txtBackReason.Text.Trim, uPara.LOGIN_HISTORY_ID)
            SetGridview()
        Else
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        If e.CommandName = "SendBack" Then
            txtIntID.Text = e.CommandArgument
            lblTitleName.Text = "ตีกลับ"
            txtBackReason.Text = "ไม่มีเอกสาร"
            ...
            Config.SaveTransLog("คลิกปุ่มตีกลับ เลขที่หนังสือ " & lbl.Text)
            zPop.Show()
        End If
    End Sub
