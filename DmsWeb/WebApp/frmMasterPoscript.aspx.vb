...
Partial Class WebApp_frmMasterPoscript
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If ValidateData() = True Then
            If txtID.Text.Trim = "" Or txtID.Text.Trim = "0" Then
                sqltmp = "insert into DOC_POSCRIPT ("
                sqltmp = sqltmp + " Poscript_code"
                sqltmp = sqltmp + ",Poscript_name"
            ...
            Else
                sqltmp = "update DOC_POSCRIPT set "
                sqltmp = sqltmp + " Poscript_code = '" + txtCode.Text + "'"
                sqltmp = sqltmp + ",Poscript_name = '" + txtName.Text + "'"
                If chkActive.Checked = True Then
    ...
    Private Sub GetData(ByVal ID As Long)
        ...
        sqltmp = "select * from DOC_POSCRIPT where id = " + ID.ToString + " order by ID"
        ...
        If (Ds.Tables("DATA").Rows.Count > 0) Then
            txtID.Text = ID
            txtCode.Text = Ds.Tables("DATA").Rows(0).Item("poscript_code").ToString
            txtName.Text = Ds.Tables("DATA").Rows(0).Item("poscript_name").ToString
    ...
    Private Sub SetGridview(ByVal IsClickSearch As Boolean)
        ...
        If IsClickSearch = True Then
            sqltmp = "select * from DOC_POSCRIPT where Poscript_name like '%" + txtSearch.Text.Trim() + "%' or Poscript_code like '%" + txtSearch.Text + "%' order by id"
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        sqltmp = "DELETE FROM DOC_POSCRIPT WHERE id=" + lbl.Text
