<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmMasterSecret.aspx.vb" Inherits="WebApp_frmMasterSecret" %>
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="secret_code" HeaderText="รหัส">
                        <ItemStyle Width="60px" HorizontalAlign="Left"></ItemStyle>
                        <HeaderStyle Width="60px" HorizontalAlign="Center"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="secret_name" HeaderText="ชื่อ">
