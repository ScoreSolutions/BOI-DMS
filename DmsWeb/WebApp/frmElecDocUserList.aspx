<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master"
    AutoEventWireup="false" CodeFile="frmElecDocUserList.aspx.vb" Inherits="WebApp_frmElecDocUserList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style2">
        ...
        <tr>
            ...
            <td align="left">
                <uc3:cmbComboBox ID="cmbTitleOwner" runat="server" Width="400" />
            </td>
        </tr>
        <tr>
            <td align="right" class="style12">
            ...
            <td align="left">
                ...
                &nbsp;
                <asp:Button ID="Button2" runat="server" CssClass="CssBtn" Text="อนุมัติ" 
                    Width="80px" />
            &nbsp;
                <asp:Button ID="btn_send" runat="server" CssClass="CssBtn" Text="ส่งต่อ" 
                    Width="80px" />
            </td>
        </tr>
        <tr>
            ...
            <td align="left" class="Csslbl" width="15%" colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="เลขที่อ้างอิง" Visible="False">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" 
                                    Font-Underline="True" ForeColor="#0000CC" 
                                    NavigateUrl='<%# bind("url_field") %>' Text='<%# bind("doc_no") %>' 
                                    Visible='<%# bind("send_status") %>'></asp:HyperLink>
                                <asp:Label ID="Label9" runat="server" Font-Bold="True" 
                                    Text='<%# bind("doc_no") %>' Visible='<%# bind("nosend_status") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
                        <asp:HyperLinkField DataNavigateUrlFields="url_field" DataTextField="doc_no" 
                            HeaderText="เลขที่อ้างอิง" Target="_parent">
                        <ItemStyle Font-Bold="True" Font-Underline="True" ForeColor="#000099" 
                            Width="100px" HorizontalAlign="Left" Wrap="True" />
                        </asp:HyperLinkField>
                        <asp:BoundField DataField="doc_create_date" HeaderText="วันที่เข้า" ItemStyle-Width="10%"
...
<ItemStyle Width="40%" HorizontalAlign="Left"></ItemStyle>
                        ...
                        <asp:BoundField DataField="org_name" HeaderText="หน่วยงานเจ้าของเรื่อง" 
                            ItemStyle-Width="20%">
<ItemStyle Width="20%" HorizontalAlign="Left"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="process" HeaderText="การดำเนินงาน" ItemStyle-Width="25%">
