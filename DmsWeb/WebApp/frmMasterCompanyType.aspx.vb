...
Partial Class WebApp_frmMasterCompanyType
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If ValidateData() = True Then
            ...
            If txtID.Text.Trim = "" Or txtID.Text.Trim = "0" Then
                txtID.Text = getdatafld("select CASE WHEN MAX(id) IS NULL THEN 1 ELSE MAX(id) + 1 END as maxid from COMPANY_TYPE", "maxid")

                sqltmp = "insert into BUSINESS_TYPE ("
                sqltmp = sqltmp + " id"
                sqltmp = sqltmp + ",business_type_code"
                sqltmp = sqltmp + ",business_type_name"
                ...
                sqltmp = sqltmp + ", '" & IIf(chkActive.Checked, "Y", "N") & "'"
                sqltmp = sqltmp + ",'" + Config.GetLogOnUser.UserName + "'"
                sqltmp = sqltmp + ",getdate())"
            Else
                sqltmp = "update BUSINESS_TYPE set "
                sqltmp = sqltmp + " business_type_name = '" + txtName.Text + "'"
                sqltmp = sqltmp + ",business_type_code = '" + txtCode.Text + "'"
                sqltmp = sqltmp + ",active = '" & IIf(chkActive.Checked, "Y", "N") & "'"
    ...
    Private Sub GetData(ByVal ID As Long)
        ...
        sqltmp = "select * from BUSINESS_TYPE where id = " + ID.ToString + " order by ID"
        ...
        If (Ds.Tables("DATA").Rows.Count > 0) Then
            ...
            txtCode.Text = Ds.Tables("DATA").Rows(0).Item("business_type_code").ToString
            txtName.Text = Ds.Tables("DATA").Rows(0).Item("business_type_name").ToString
    ...
    Private Sub SetGridview(ByVal IsClickSearch As Boolean)
        ...
        If IsClickSearch = True Then
            sqltmp = "select * from BUSINESS_TYPE where business_type_name like '%" + txtSearch.Text.Trim() + "%'  or business_type_code like '%" + txtSearch.Text + "%' "
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        sqltmp = "DELETE FROM BUSINESS_TYPE WHERE id=" + lbl.Text
