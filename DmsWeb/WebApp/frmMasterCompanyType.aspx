...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%">
        <tr>
            <td class="CssHead">
                <span lang="TH">ข้อมูลประเภทกิจการ</span></td>
        ...
        <tr>
            <td align="right" class="Csslbl" width="20%">
                รหัส<span lang="TH">ประเภทกิจการ</span> :
            </td>
        ...
        <tr>
            <td align="right" class="Csslbl">
                ชื่อ<span lang="TH">ประเภทกิจการ</span> :
            </td>
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="business_type_code" HeaderText="รหัส">
                            <ItemStyle Width="60px" HorizontalAlign="Center"></ItemStyle>
                            <HeaderStyle Width="60px" HorizontalAlign="Center"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="business_type_name" HeaderText="ชื่อ" 
