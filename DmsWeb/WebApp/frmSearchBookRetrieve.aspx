<%@ Page Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false"
    CodeFile="frmSearchBookRetrieve.aspx.vb" Inherits="WebApp_frmSearchBookRetrieve" Title="ค้นหาหนังสือเพื่อดึงกลับ" %>
            ...
            <td align="left" class="Csslbl" width="15%" colspan="4">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="document_int_receiver_id" >
                            <ControlStyle CssClass="zHidden" />
                            <FooterStyle CssClass="zHidden" />
                            <HeaderStyle CssClass="zHidden" />
                            <ItemStyle CssClass="zHidden" />
                        ...
                        <asp:BoundField DataField="company_doc_date" DataFormatString="{0:dd/MM/yyyy}" HeaderText="วันที่เอกสาร" HtmlEncode="False" SortExpression="company_doc_date"  />
                        ...
                        <asp:TemplateField ShowHeader="False" >
                            ...
                            <ItemTemplate>
                                <asp:Button ID="btnRetrieve" runat="server" CssClass="CssBtn" Text="ดึงกลับ" CommandArgument='<%# Bind("document_int_receiver_id") %>' CommandName="Retrieve" Width="50px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
    ...
    <asp:Panel ID="Panel1" runat="server" Width="500">
        <table id="Table1" width="500" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
            ...
            <tr>
                ...
                <td colspan="3">
                    <uc1:txtAutoComplete ID="txtRetrieveReason" Width="250" runat="server" Text="ส่งผิดสำนัก" IsNotNull="true" />
                    <uc1:txtAutoComplete ID="txtIntID" runat="server"  Visible="false" />
                </td>
            </tr>
            <tr>
                <td colspan="4">
