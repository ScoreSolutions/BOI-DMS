<%@ Page Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" MaintainScrollPositionOnPostback="true" ValidateRequest="false" AutoEventWireup="false" CodeFile="frmDocFormEntry.aspx.vb" EnableEventValidation="false" Inherits="WebApp_frmDocFormEntry"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" >
        ...
        <tr>
            <td colspan="4" align="right" >
                <asp:Button ID="btnSave" runat="server" CssClass="CssBtnPad" Text="บันทึก" 
                    Width="80px" />
                <asp:Button ID="btnCancel" runat="server" CssClass="CssBtnPad" Text="ยกเลิก" 
                    Width="80px" />
                <asp:Button ID="btnPrint" runat="server" CssClass="CssBtnPad" Text="พิมพ์" 
                    Width="80px" />
                <asp:Button ID="btnSend" runat="server" CssClass="CssBtnPad" Text="ส่งต่อ" 
                    Width="80px" Visible="False" />
                <asp:Button ID="btnSaveSend" runat="server" CssClass="CssBtnPad" 
                    Text="บันทึกพร้อมส่ง" Width="110px" />
                <asp:Button ID="btnApprove" runat="server" CssClass="CssBtnPad" Text="อนุมัติ" 
                    Width="110px" />
            </td>
        </tr>
        <tr>
    ...
    <asp:Panel ID="Panel8" runat="server" BorderColor="#3B5998" BorderStyle="Solid" Width="850px">
        <table id="Table2" runat="server" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" style="border: solid 0px 0px 0px 0px #ff0000" width="100%">
                ...
                <tr>
                    ...
                    <td align="left" class="style7" width="220">
                        ...
                        <asp:ListSearchExtender id="ListSearchExtender1" runat="server" TargetControlID="cmbTitleOwnerTo" PromptText=""
                            PromptCssClass="zComboBox" PromptPosition="Bottom" QueryTimeout="0" QueryPattern="Contains" IsSorted="true"   />
            ...
            <td width="170">
                &nbsp;</td>
                <td align="left">
                    <asp:Button ID="btnYes2" runat="server" CssClass="CssBtn" Text="เพิ่ม" 
                        Width="80" />
                    &nbsp; <asp:Button ID="btnNo3" runat="server" CssClass="CssBtn" Text="ส่ง" 
                        Width="80" />
                </td>
            </tr>
            </table>
            ...
            <table id="Table6" runat="server" bgcolor="#ffffff" border="0" cellpadding="0" 
                cellspacing="0" width="100%">
            <tr>
            <td height="26" class="style33">
