...
Imports System.Data
Partial Class UserControls_ctlSubCategory
    ...
    Public Function ValidateData() As Boolean
        ...
        If cmbCategory.SelectedValue = 0 Then
            ret = False
            Config.SetAlert("กรุณาเลือกประเภท", Me.Page)
    ...
    Protected Sub GridView1_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles GridView1.SelectedIndexChanging
        ...
        para = fnc.GetDocSubCategoryPara(K(0))

        lblID.Text = para.ID
        txtBox1.Text = para.SUBCATEGORY_CODE
        txtBox2.Text = para.SUBCATEGORY_NAME
    ...
    Private Sub Search(ByVal IsClickSearch As Boolean)
        ...
        If IsClickSearch = True Then
            Dim fnc As New DocSubCategoryEng
            dt = fnc.GetDataSubCategoryList("subcategory_code like '%" & txtBox1.Text & "'", "subcategory_code")
            Session("SearchResult") = dt
        Else
            Dim sortStr As String = ""
            If txtSortField.Text.Trim <> "" Then
        ...
        If dt.Rows.Count = 1 Then
            txtBox1.Text = dt.Rows(0)("subcategory_code")
            txtBox2.Text = dt.Rows(0)("subcategory_name")
            lblID.Text = dt.Rows(0)("id")
        Else
            If dt.Rows.Count = 0 Then
                Dim fnc As New DocSubCategoryEng
                dt = fnc.GetDataSubCategoryList("", "") 'ถ้าผลลัพธ์ที่ได้มี 0 รายการ ให้แสดงออกมาทั้งหมด
            End If
    ...
    Protected Sub ImageSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageSearch.Click
        Search(True)
    End Sub
    Public ReadOnly Property SubCategoryParameter() As DocSubcategoryPara
        Get
            Dim para As New DocSubcategoryPara
            If lblID.Text.Trim <> "" And lblID.Text.Trim <> "0" Then
                Dim fnc As New DocSubCategoryEng
                para = fnc.GetDocSubCategoryPara(lblID.Text)
            End If
            Return para
        End Get
    End Property
    ...
    Protected Sub imgClose_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgClose.Click
        Dim para As DocSubcategoryPara = SubCategoryParameter()
        If para.ID = 0 Then
            ClearAllField()
            txtBox1.Focus()
        End If
