...
Imports System.Data
Partial Class UserControls_ctlDocSecret
    ...
    Protected Sub GridView1_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles GridView1.SelectedIndexChanging
        ...
        para = fnc.GetDocSecretPara(K(0))

        lblID.Text = para.ID
        txtBox1.Text = para.SECRET_CODE
        txtBox2.Text = para.SECRET_NAME
    ...
    Private Sub Search(ByVal IsClickSearch As Boolean)
        ...
        If IsClickSearch = True Then
            Dim fnc As New DocSecretEng
            dt = fnc.GetDataSecretList("secret_code like '%" & txtBox1.Text & "'", "secret_code")
            Session("SearchResult") = dt
        Else
            Dim sortStr As String = ""
            If txtSortField.Text.Trim <> "" Then
        ...
        If dt.Rows.Count = 1 Then
            txtBox1.Text = dt.Rows(0)("secret_code")
            txtBox2.Text = dt.Rows(0)("secret_name")
            lblID.Text = dt.Rows(0)("id")
        Else
            If dt.Rows.Count = 0 Then
                Dim fnc As New DocSecretEng
                dt = fnc.GetDataSecretList("", "") 'ถ้าผลลัพธ์ที่ได้มี 0 รายการ ให้แสดงออกมาทั้งหมด
            End If
    ...
    Protected Sub ImageSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageSearch.Click
        Search(True)
    End Sub
    Public ReadOnly Property SecretParameter() As DocSecretPara
        Get
            Dim para As New DocSecretPara
            If lblID.Text.Trim <> "" And lblID.Text.Trim <> "0" Then
                Dim fnc As New DocSecretEng
                para = fnc.GetDocSecretPara(lblID.Text)
            End If
            Return para
        End Get
    End Property
    ...
    Protected Sub imgClose_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgClose.Click
        Dim para As DocSecretPara = SecretParameter()
        If para.ID = 0 Then
            ClearAllField()
            txtBox1.Focus()
        End If
