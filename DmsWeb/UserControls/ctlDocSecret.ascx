<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlDocSecret.ascx.vb"
    Inherits="UserControls_ctlDocSecret" %>
...
<asp:Label ID="lblCaption" runat="server" CssClass="CssHead" Text="ระดับชั้นความลับ"></asp:Label>
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="secret_code" HeaderText="รหัส" SortExpression="secret_code">
                        ...
                        <asp:BoundField DataField="secret_name" HeaderText="ชื่อ" SortExpression="secret_name">
