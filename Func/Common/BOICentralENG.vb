...
Namespace Common
    Public Class BOICentralENG
        ...
        Public Shared Function GetCompanyList(ByVal WhText As String) As DataTable
            Dim sql As String = "select top 100 loid as id, case when ltrim(tName)='' then eName else tName end + ' (" & Para.Common.Utilities.Constant.CompanySourceType.BOICENTRAL & ")' company_name"
            sql += " from company "
