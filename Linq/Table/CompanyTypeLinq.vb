...
Namespace TABLE
    'Represents a transaction for COMPANY_TYPE table Linq.
    '[Create by  on July, 23 2012]
    Public Class CompanyTypeLinq
        Public sub CompanyTypeLinq()

        End Sub 
        ' COMPANY_TYPE
        Const _tableName As String = "COMPANY_TYPE"
...
Public Property PREFIX_NAME() As Char
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into COMPANY_TYPE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to COMPANY_TYPE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from COMPANY_TYPE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of COMPANY_TYPE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of COMPANY_TYPE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As CompanyTypeLinq
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of COMPANY_TYPE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As CompanyTypePara
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of COMPANY_TYPE by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("company_type_id")) = False Then _company_type_id = Rdr("company_type_id").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CompanyTypeLinq
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of COMPANY_TYPE by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As CompanyTypePara
            ClearData()
            _haveData  = False
            Dim ret As New CompanyTypePara
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("company_type_id")) = False Then ret.company_type_id = Rdr("company_type_id").ToString()
        ...
        'Get Insert Statement for table COMPANY_TYPE
        Private ReadOnly Property SqlInsert() As String 
            Get
                ...
                sql += DB.SetString(_COMPANY_TYPE_ID) & ", "
        ...
        'Get update statement form table COMPANY_TYPE
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "COMPANY_TYPE_ID = " & DB.SetString(_COMPANY_TYPE_ID) & ", "
        ...
        'Get Delete Record in table COMPANY_TYPE
        ...
        'Get Select Statement for table COMPANY_TYPE
