...
Namespace TABLE
    'Represents a transaction for LOG_TRANS table Linq.
    '[Create by  on March, 1 2013]
    Public Class LogTransLinq
        Public sub LogTransLinq()
        ...
        Public Property TRANS_DATE() As DateTime
            ...
            End Set
        End Property 
        <Column(Storage:="_TRANS_DESC", DbType:="Text")>  _
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As LogTransLinq
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As LogTransPara
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of LOG_TRANS by specified TRANS_DATE key is retrieved successfully.
        ...
        Public Function ChkDataByTRANS_DATE(cTRANS_DATE As DateTime, trans As SQLTransaction) As Boolean
            Return doChkData("TRANS_DATE = " & DB.SetDateTime(cTRANS_DATE) & " ", trans)
        End Function

        '/// Returns an duplicate data record of LOG_TRANS by specified TRANS_DATE key is retrieved successfully.
        '/// <param name=cTRANS_DATE>The TRANS_DATE key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByTRANS_DATE(cTRANS_DATE As DateTime, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("TRANS_DATE = " & DB.SetDateTime(cTRANS_DATE) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of LOG_TRANS by specified CREATE_ON key is retrieved successfully.
        '/// <param name=cCREATE_ON>The CREATE_ON key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByCREATE_ON(cCREATE_ON As DateTime, trans As SQLTransaction) As Boolean
            Return doChkData("CREATE_ON = " & DB.SetDateTime(cCREATE_ON) & " ", trans)
        End Function

        '/// Returns an duplicate data record of LOG_TRANS by specified CREATE_ON key is retrieved successfully.
        '/// <param name=cCREATE_ON>The CREATE_ON key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByCREATE_ON(cCREATE_ON As DateTime, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("CREATE_ON = " & DB.SetDateTime(cCREATE_ON) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As LogTransLinq
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As LogTransPara
            ClearData()
            _haveData  = False
            Dim ret As New LogTransPara
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_ON, UPDATE_BY, UPDATE_ON, LOGIN_HIS_ID, TRANS_DATE, TRANS_DESC FROM " & tableName
                Return Sql
            End Get
        End Property
