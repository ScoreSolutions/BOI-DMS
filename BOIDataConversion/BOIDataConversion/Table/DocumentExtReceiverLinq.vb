...
Imports DB = BOIDataConversion.Utilities.SqlDB
Imports BOIDataConversion.TABLE
Imports BOIDataConversion.Utilities
...
Namespace TABLE
    ...
    Public Class DocumentExtReceiverLinq
        ...
        Dim _APPROVE_DATE As DateTime = New DateTime(1,1,1)
        ...
        Public Property SENDER_OFFICER_FULLNAME() As String
            ...
            End Set
        End Property 
        <Column(Storage:="_BOOKOUT_NO", DbType:="VarChar(50) NOT NULL ",CanBeNull:=false)>  _
        ...
        Public Property MAXIMUM_PROCESSING_PERIOD() As  System.Nullable(Of Double) 
            ...
            End Set
        End Property 
        <Column(Storage:="_APPROVE_DATE", DbType:="DateTime NOT NULL ",CanBeNull:=false)>  _
        Public Property APPROVE_DATE() As DateTime
            Get
       ...
       'Define Public Method 
        ...
        Public Function InsertData(ByVal trans As SqlTransaction) As Boolean
        ...
        Public Function UpdateByPK(ByVal trans As SqlTransaction) As Boolean
            If trans IsNot Nothing Then
        ...
        '/// Returns an indication whether the record of DOCUMENT_EXT_RECEIVER by specified COMPANY_ID_RECEIVE_DOCUMENT_REGISTER_ID key is retrieved successfully.
        '/// <param name=cCOMPANY_ID_RECEIVE_DOCUMENT_REGISTER_ID>The COMPANY_ID_RECEIVE_DOCUMENT_REGISTER_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByCOMPANY_ID_RECEIVE_DOCUMENT_REGISTER_ID(cCOMPANY_ID_RECEIVE As Long, cDOCUMENT_REGISTER_ID As Long, trans As SQLTransaction) As Boolean
            Return doChkData("COMPANY_ID_RECEIVE = " & DB.SetDouble(cCOMPANY_ID_RECEIVE) & " AND DOCUMENT_REGISTER_ID = " & DB.SetDouble(cDOCUMENT_REGISTER_ID), trans)
        End Function

        '/// Returns an duplicate data record of DOCUMENT_EXT_RECEIVER by specified COMPANY_ID_RECEIVE_DOCUMENT_REGISTER_ID key is retrieved successfully.
        '/// <param name=cCOMPANY_ID_RECEIVE_DOCUMENT_REGISTER_ID>The COMPANY_ID_RECEIVE_DOCUMENT_REGISTER_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByCOMPANY_ID_RECEIVE_DOCUMENT_REGISTER_ID(cCOMPANY_ID_RECEIVE As Long, cDOCUMENT_REGISTER_ID As Long, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("COMPANY_ID_RECEIVE = " & DB.SetDouble(cCOMPANY_ID_RECEIVE) & " AND DOCUMENT_REGISTER_ID = " & DB.SetDouble(cDOCUMENT_REGISTER_ID) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
